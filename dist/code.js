...
(() => {
  ...
  var cardColors = {
    "Business Outcome": "#44367B",
    // Violet 70
    "Product Outcome": "#004477",
    // Blue 70
    "Objective": "#44367B",
    // Violet 70
    "Key Result": "#004477",
  ...
  var cardLinkColors = {
    "Business Outcome": "#534296",
    // Violet 60
    "Product Outcome": "#0073B9",
    // Blue 50
    "Objective": "#534296",
    // Violet 60
    "Key Result": "#0073B9",
  ...
  var cardTextColors = {
    "Business Outcome": "#271F47",
    // Violet 90
    "Product Outcome": "#002342",
    // Blue 90
    "Objective": "#271F47",
    // Violet 90
    "Key Result": "#002342",
  ...
  var cardBackgroundColors = {
    "Business Outcome": "#F3F1F9",
    // Violet 5
    "Product Outcome": "#EBF4FA",
    // Blue 5
    "Objective": "#F3F1F9",
    // Violet 5
    "Key Result": "#EBF4FA",
  ...
  function CardTypeLabel({ label, fillColor }) {
    ...
    return /* @__PURE__ */ figma.widget.h(AutoLayout, { padding, fill: fillColor, cornerRadius: radius }, /* @__PURE__ */ figma.widget.h(
      Text,
      {
        fontWeight: "bold",
        letterSpacing: 0.2,
        fontSize: 18,
        fill: cardLabelTextColors[label]
      },
      label
    ));
  }
  function CardStatusLabel({ label, color }) {
    return /* @__PURE__ */ figma.widget.h(AutoLayout, { verticalAlignItems: "center", spacing: 10, padding: { top: 4, bottom: 0, left: 0, right: 0 } }, /* @__PURE__ */ figma.widget.h(Text, { fontWeight: "bold", fontSize: 18, fill: "#333" }, label), /* @__PURE__ */ figma.widget.h(AutoLayout, { cornerRadius: 100, fill: color, width: 10, height: 10 }));
  }
  function ExpandTip({ color, widgetId }) {
    ...
    return /* @__PURE__ */ figma.widget.h(AutoLayout, { hidden: !hideChildren }, /* @__PURE__ */ figma.widget.h(
      AutoLayout,
      {
        ...
        height: 18,
        fill: color,
        cornerRadius: { topLeft: 0, topRight: 0, bottomLeft: 24, bottomRight: 24 }
      },
  ...
  function Note({ cardType }) {
    ...
    return /* @__PURE__ */ figma.widget.h(
      Input,
      {
        ...
        fontSize: 20,
        lineHeight: 28,
        fill: cardTextColors[cardType],
        placeholder: placeholderTexts[cardType],
        placeholderProps: {
          fill: placeholderTextColors[cardType],
          fontSize: 20,
          lineHeight: 28
        },
        inputFrameProps: {
  ...
  function DebugInfo() {
    ...
    return /* @__PURE__ */ figma.widget.h(AutoLayout, { direction: "vertical", padding: { top: 16, right: 24, left: 24, bottom: 16 } }, /* @__PURE__ */ figma.widget.h(Text, null, "// DEBUG: ", useWidgetNodeId(), " //"), /* @__PURE__ */ figma.widget.h(Text, null, runtimeDebugInfo));
  }
  ...
  function Links({ cardType }) {
    ...
    return /* @__PURE__ */ figma.widget.h(AutoLayout, { hidden: links.length <= 0, width: "fill-parent", direction: "vertical", padding: { top: 0, left: 24, right: 24, bottom: 32 }, spacing: 12 }, links.map(
      (l) => {
        if (linksInEditing) {
          ...
          return /* @__PURE__ */ figma.widget.h(
            ...
            /* @__PURE__ */ figma.widget.h(SVG, { src: `
                ...
                ` }),
            /* @__PURE__ */ figma.widget.h(Text, { fill: cardLinkColors[cardType] }, l.text)
          );
        }
      }
    ), linksInEditing == true && /* @__PURE__ */ figma.widget.h(AutoLayout, { width: "fill-parent", direction: "vertical", spacing: 24 }, /* @__PURE__ */ figma.widget.h(
      AutoLayout,
      {
        width: "fill-parent",
        verticalAlignItems: "center",
      ...
      /* @__PURE__ */ figma.widget.h(SVG, { positioning: "absolute", y: 2, opacity: 0, hoverStyle: { opacity: 1 }, src: `
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="14" height="14">
            <path fill="#333A3D" d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 192H32c-17.7 0-32 14.3-32 32s14.3 32 32 32H224V480c0 17.7 14.3 32 32 32s32-14.3 32-32V288l192 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-192 0 0-192z"/>
          </svg>
        ` }),
      /* @__PURE__ */ figma.widget.h(Text, { positioning: "absolute", x: 24, fill: "#69757A", hoverStyle: { fill: "#333A3D" } }, "Add a link")
    ), /* @__PURE__ */ figma.widget.h(
      AutoLayout,
      {
        fill: "#333A3D",
  ...
  function Widget() {
    ...
    return /* @__PURE__ */ figma.widget.h(AutoLayout, { direction: "vertical", horizontalAlignItems: "center", padding: { bottom: 0 } }, /* @__PURE__ */ figma.widget.h(
      AutoLayout,
      {
        width: 425,
        height: "hug-contents",
        ...
        fill: cardBackgroundColors[cardType],
        stroke: cardColors[cardType],
        strokeWidth: 4,
        effect: shadow
      },
      cardStatus != "none" ? /* @__PURE__ */ figma.widget.h(AutoLayout, { verticalAlignItems: "center", spacing: "auto", width: "fill-parent", padding: { left: 0, top: 0, bottom: 0, right: 24 } }, /* @__PURE__ */ figma.widget.h(
        CardTypeLabel,
        {
          label: cardLabels[cardType],
          fillColor: cardColors[cardType]
        }
      ), /* @__PURE__ */ figma.widget.h(CardStatusLabel, { label: cardStatus, color: cardStatuses[cardStatus].color })) : /* @__PURE__ */ figma.widget.h(
        CardTypeLabel,
        {
          label: cardLabels[cardType],
          fillColor: cardColors[cardType]
      ...
      /* @__PURE__ */ figma.widget.h(Links, { cardType }),
